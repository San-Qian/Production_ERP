...
<script type="text/javascript">
    ...
    function submitOrderAddForm() {
        ...
        $.post("custom/check", $("#orderAddForm").serialize(), function (data) {
            if (data.msg != null) {
                $.messager.confirm('确认', data.msg + '，确定提交吗？', function (r) {
                    if (r) {
                        $.post("product/check", $("#orderAddForm").serialize(), function (data) {
                            if (data.msg != null) {
                                $.messager.confirm('确认', data.msg + '，确定提交吗？', function (r) {
                                    if(r){
